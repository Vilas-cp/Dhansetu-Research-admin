...
const itServiceData1 = [
  {
    text: `As a leading IT development service provider, Dhansetu Research can transform your business with robust
    ...
    <>
      ...
      <div className="pt-[40px]">
        <div className="w-full card-container md:w-[80%] md:px-0 px-2 mx-auto h-auto py-5 flex items-center flex-wrap">
          ...
          <h2 className="text-black font-bold text-2xl">
            Why Choose Dhansetu Research as an IT Development Partner?
          </h2>
          <div className="space-y-3 py-6">
