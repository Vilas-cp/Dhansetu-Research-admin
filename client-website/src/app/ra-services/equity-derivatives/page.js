...
import UlLiComp from "@/app/ra-services/compo/UlLiComp";
      ...
      <div className="pt-[80px] pb-2">
        ...
        <div className="w-full flex xl:flex-row flex-col-reverse">
          ...
          <div className="flex xl:flex-row flex-col-reverse justify-between flex-shrink-0 w-full xl:w-3/4">
            <div>
              <h3 className="pl-2 font-semibold pt-2 text-2xl">{`Our reports move beyond surface-level commentary. Each insight is crafted using:`}</h3>
